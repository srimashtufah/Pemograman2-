...
<html>
    <head>
        ...
        <title>Master Data Mata Kuliah</title>
    </head>
    <body>
        <%
            String userName = "";
            ...
            <div class='main-layout'>
                ...
                <main class='content-area'>
                    ...
                    <div class='card-body' style='text-align: left;'>
                        ...
                        <p class='sub-konten'>Halaman untuk mengelola daftar mata kuliah universitas.</p>
                        ...
                        <div style='padding: 20px; background: #f8fafc; border-radius: 8px; border: 1px dashed #cbd5e1; text-align: center; color: #64748b;'>
                            [ Konten Tabel Data Mata Kuliah Akan Dibuat Di Sini ]
                        </div>
                    </div>
                </main>
            </div>
